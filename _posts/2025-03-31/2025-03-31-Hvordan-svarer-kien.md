...
Hvis vi skal generere en setning med 100 ord og har en sannsynlighet for å velge riktig ord på 99.999% får vi følgende: $P(\text{riktig setning}) = (1-0.99999)^100 = 0.0$. Altså er det 0% sannsynlighet for at vi generer den helt riktige setningen, selv med en ekstremt høy sannsynlighet for å velge riktig ord i hvert forsøk.
